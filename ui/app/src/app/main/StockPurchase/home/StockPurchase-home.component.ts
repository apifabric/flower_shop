...
@Component({
  selector: 'StockPurchase-home',
  templateUrl: './StockPurchase-home.component.html',
  styleUrls: ['./StockPurchase-home.component.scss']
})
export class StockPurchaseHomeComponent implements AfterViewInit {
