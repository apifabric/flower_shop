...
@Component({
  selector: 'WorkSchedule-home',
  templateUrl: './WorkSchedule-home.component.html',
  styleUrls: ['./WorkSchedule-home.component.scss']
})
export class WorkScheduleHomeComponent implements AfterViewInit {
