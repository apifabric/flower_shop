...
@Component({
  selector: 'OrderPromotion-home',
  templateUrl: './OrderPromotion-home.component.html',
  styleUrls: ['./OrderPromotion-home.component.scss']
})
export class OrderPromotionHomeComponent implements AfterViewInit {
