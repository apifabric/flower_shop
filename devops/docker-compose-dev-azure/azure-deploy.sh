...
resourcename="flowershop"  # lower case, only
resourcegroup="flowershop_rg"
...
# git clone https://github.com/apilogicserver/flowershop.git
# cd flowershop
...
az group create --name flowershop_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group flowershop_rg --sku S1 --is-linux
az container create --resource-group flowershop_rg --name flowershop --image apilogicserver/flowershop:latest --dns-name-label flowershop --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//flowershop.westus.azurecontainer.io:5656'
