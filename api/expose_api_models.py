...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.Flower, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.StockPurchase, method_decorators= method_decorators)
    api.expose_object(database.models.Supplier, method_decorators= method_decorators)
    api.expose_object(database.models.WorkSchedule, method_decorators= method_decorators)
    return api
